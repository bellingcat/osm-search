<template>
    ...
    <p>This policy is effective as of 15 June 2023.</p>
    ...
    <p>
      ...
      prevent loss and theft, as well as unauthorised access, disclosure, copying,
      use or modification.
    </p>
    <p>
    ...
    <p>
      ...
      Netherlands, or where we or our partners, affiliates, and third-party
    ...
    <p>
      ...
      this privacy policy. If you are a third party providing personal information
    ...
    <p>
      ...
      service or offer (for example processing transaction data), we will not deny
      you goods or services and/or charge you different prices or rates for goods
    ...
    <p>
      ...
      the details below and provide us with full details of the alleged breach. We
    ...
    <p>
      ...
      computer, and accesses each time you visit, so we can understand how you use
      our site. This helps us serve you content based on preferences you have
      specified.
    </p>
    ...
    <p>
      ...
      organizations (known as &ldquo;data processors&rdquo;). We, Bellingcat,
    ...
    <p>
      ...
      consent to your name and email address being used so we can respond to your
      enquiry. While you may request that we delete your contact details at any
      time, we cannot recall any email we have already sent. If you have any
      further enquiries about how to withdraw your consent, please feel free to
      enquire using the details provided in the Contact Us section of this privacy
      policy.
    </p>
    ...
    <p>
      ...
      personal information solely for the purpose of a legal claim; or (iv) we are
      in the process of considering your objection in relation to processing on
    ...
    <p>
      ...
      Please be aware that search engines and similar third parties may still
      retain copies of your personal information that has been made public at
      least once, like certain profile information and public comments, even after
